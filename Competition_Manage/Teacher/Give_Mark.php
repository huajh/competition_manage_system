...
<tbody>
	...
	<div id=nav_index>
 	 <div id="menu">
   	 <ul><li><?php echo "<a href=\"teacher_Index.php\"><font color='purple'>首页</font></a>;";?> </li>
   	 <li><?php echo "<a href=\"Give_Mark.php\"><font color='purple'>评分</font></a>;";?> </li>
		...
		<td align="center" bgcolor="#ffffff" colspan="2" height="155" valign="top" width="1055px"><table width="100%" height="30px"><tr>
			...
			<strong><?php echo "教师：$user_name"; ?></strong></td></tr></table>
	  ...
	  <td colspan="2"> 
		<table width="100%" border="1" >
          <tr> 
            ...
            <th width="80" align="center">名字</th>
            <th width="300" align="center">作品</th>
            <th width="60" align="center">成绩</th>
            <th width="150" align="center"><font size="2">已评分次数（一共需要评10次，每位老师最多评一次）</font></th>
          </tr>
<?php
foreach($List as $key => $value){									//循环显示信息列表
	...
	$Have_Hand_In=$value['Have_Hand_In'];
	$marked_Num=$value['marked_Num'];
?>		<?php if($marked_Num<10 && $Have_Hand_In!=''){ ?>
          <tr <?php echo $bgstr ?> > 
            <td align="center"> <?php echo $value['F_ID'] ?> </td>
            <td align="center"> <?php echo $value['user_Name'] ?> </td>
            <td align="center"> <?php echo "<a href ='$destination_folder'>点击下载学生作品</a>"; ?></td>
            <td width="5" align="center">
            <form name="form" method="post" action="Mark_Ok.php ? id=<?php echo $value['F_ID']?>" ><center>
            <input name="Score" type="text"  maxlength="3"></input>
            <input type="submit" name="Submit" value="确定"></center></form>  </td>
            <td align="center"> <?php echo $marked_Num ?> </td> 
          </tr>
          <?php }?>    
<?php
}
