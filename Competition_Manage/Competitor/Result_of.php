...
<?php 
	...
	$ID=$_SESSION["F_ID"];
	$sign=$_SESSION["user_sign"];
	$handInTime=$_SESSION["handInTime"];
...
<tbody>
	...
	<div id=nav_index>
 	 <div id="menu">
   	 <ul><li><?php echo "<a href=\"Competitor_Index.php\"><font color='purple'>首页</font></a>;";?> </li>
...
?>
	<table width="50%" border="0" align="center">
	 <tr> 
	  <td width="30%" align="right"  class="caption"><font face='Modern' size=2 color='fuchsia'>你的成绩是:</font></td>
	  <td width="70%"><font color='teal' size=3><u><?php 
	  if($Score==0){
	  	echo "成绩还没出来,耐心等待吧！(*^__^*)";
	  }else{
	    echo $Score;
	    }?>
	  </u></font></td>
	 ...
	 <tr> 
	  <td width="18%" align="right"  class="caption"><font face='Modern' size=2 color='fuchsia'>获奖情况:</font></td>
	  <td width="82%"><font color='teal' size=3><u><?php 
	  if($Awards==''){
	  	echo "";
	  }else{
	  	echo "恭喜你获得了：";
...
<form name="form1" method="post" action="">
		<table width="100%" border="0">
          <tr> 
          <th width="30" ><font size='2' color='blue' face='仿宋'>序号</font></th>
            <th width="120"><font size='2' color='blue' face='仿宋'>学号</font></th>
            <th width="80"><font size='2' color='blue' face='仿宋'>名字</font></th>
            <th width="300"><font size='2' color='blue' face='仿宋'>看看获奖者说些什么吧！</font></th>
            <th width="60"><font size='2' color='blue' face='仿宋'>成绩</font></th>
            <th width="80"><font size='2' color='blue' face='仿宋'>奖项</font></th>
          </tr>
<?php
$i=0;
...
?>
          ...
          <td> <?php echo $i ?> </td>
            ...
            <td><font size='2' color='purple' face='仿宋'> <?php echo $value['user_sign'] ?></font> </td>
