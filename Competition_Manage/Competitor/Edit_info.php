  ...
  <tr>
   <td > 
	<table width="70%" border="0" align="center">
	 <tr> 
	  <td width="30%" align="right"  class="caption"><font face='Modern' size=3 color='fuchsia'>帐号:</font></td>
	  <td width="70%"><font color='teal'><u><?php echo $user_name?></u></font></td>
	 </tr>
	 	<tr> 
	  <td width="18%" align="right"  class="caption"><font face='Modern' size=3 color='fuchsia'>学号:</font></td>
	  <td width="82%"><font color='teal'><u><?php echo $ID?></u></font></td>
	 </tr>
	 <tr> 
	  <td width="18%" align="right"  class="caption"><font face='Modern' size=3 color='fuchsia'>签名:</font></td>
	  <td width="82%"><font color='teal'><u><?php echo $sign?></u></font></td>
	 </tr>
	 </table>
	 <table width="50%" border="0" align="center" background="white">
	 <tr>
	  <th height="30" class="caption" align="center"><font face= "黑体" size=2 color="blue">添加你的个性签名吧！(其他选手将在竞赛结果中看到你的签名)</font></th>
	   </tr>
	 <tr> 
	  ...
	  <table width="50%" border="0" align="center">
  		<tr>
   		<th height="23" class="caption"><font color='lime'>修改密码</font></th>
 	 </tr>
	 <tr> 
	 ...
	 <tr> 
	  ...
	  <td><input name="user_pw2" type="password" id="pwd2" maxlength="20">
	   再次输入密码</td>
	     ...
	     <tr>
       <td align="center"><div align="center">验证码</div></td>
